...
const FacultyLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token, faculty_id, institution_id, and faculty name in localStorage
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200 ease-in-out text-base"
