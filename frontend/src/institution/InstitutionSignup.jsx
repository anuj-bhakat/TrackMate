...
const InstitutionSignup = () => {
  ...
  useEffect(() => {
    // Check if institutionToken exists, if yes redirect to institution dashboard
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.institution || !formData.username || !formData.password || !formData.confirmPassword) {
    ...
    try {
      ...
      await axios.post(`${baseUrl}/api/institutions/signup`, signupData);
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Register your institution with TrackMate
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div className="relative" ref={dropdownRef}>
              ...
              <div
                className="relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-200 ease-in-out text-sm cursor-pointer"
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-200 ease-in-out text-sm"
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/institution-login" className="font-medium text-orange-600 hover:text-orange-500">
                Sign in
              </a>
            </p>
          </div>
