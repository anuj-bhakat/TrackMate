        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <span className={institution ? 'text-gray-900' : 'text-gray-500'}>
                  {loadingInstitutions ? (
                    <div className="flex items-center gap-2">
                      <Loader className="h-5 w-5" color="text-indigo-600" />
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="group relative w-full flex justify-center py-3 px-4 border border-indigo-600 text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Sign in as Guest
            </button>
          </div>
