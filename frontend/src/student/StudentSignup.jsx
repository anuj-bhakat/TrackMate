...
const StudentSignup = () => {
  ...
  useEffect(() => {
    // Check if studentToken exists, if yes redirect to student dashboard
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.institution || !formData.studentId || !formData.name || !formData.username || !formData.password || !formData.confirmPassword) {
    ...
    try {
      ...
      await axios.post(`${baseUrl}/api/students/signup`, signupData);
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div className="relative" ref={dropdownRef}>
              ...
              <div
                className="relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 ease-in-out text-sm cursor-pointer"
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 ease-in-out text-sm"
